/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   htm-app.js â€” Landing page sin Babel, usando htm + React
...
(function(){
  ...
  /* â”€â”€â”€ GLASS PRIMITIVES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  ...
  /* â”€â”€â”€ BLUR TEXT (word-by-word entrance) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  ...
  /* â”€â”€â”€ CINEMATIC BACKGROUND â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  ...
  /* expose modules to global so split files could share â€” but here we keep all in one */
  ...
  function Nav() {
    const links = [
      { l:'Marco', h:'recurso.html#parte-i' }, { l:'LÃ­nea', h:'recurso.html?timeline=1#sc' },
    ...
    return html`
      <nav className="fixed top-4 left-0 right-0 z-50 px-6 lg:px-12 flex items-center justify-between">
        <${motion.a} href="#top" className="liquid-glass w-12 h-12 rounded-full flex items-center justify-center font-heading italic text-paper text-2xl leading-none" initial=${{ opacity:0, y:-10 }} animate=${{ opacity:1, y:0 }} transition=${{ duration:0.5, ease:'easeOut' }} aria-label="Inicio">æ¼«</>
          ...
          <div className="max-w-5xl mx-auto w-full text-center">
            <${motion.div} ...${fadeUp} transition=${{...ease, delay:0.4}} className="inline-block mb-8">
              <${Pill} className="!py-1 !px-1">
                ...
                <span className="pr-3 text-paper/90 font-mono text-[11px] uppercase tracking-kicker">v5.9 â€” Itinerarios Infantil + Primaria ya disponibles</span>
              </>
            </>
            <${motion.div} ...${fadeUp} transition=${{...ease, delay:0.5}} className="font-mono text-[11px] uppercase tracking-kicker text-paper/70 mb-6">
              Aula de CÃ³mic Â· Biblioteca Campus del Obelisco Â· ULPGC
            </>
            <${BlurText} text="El manga como recurso didÃ¡ctico." italic delay=${0.7} stagger=${140} className="font-heading text-paper text-[clamp(3rem,9vw,7.5rem)] leading-[0.95] tracking-[-0.03em] font-semibold mb-6 justify-center" tag="h1" />
            <${motion.p} ...${fadeUp} transition=${{...ease, delay:1.15}} className="mx-auto max-w-2xl text-paper/80 text-lg md:text-xl leading-relaxed font-body mb-10">
              Marco pedagÃ³gico, catÃ¡logo curado de <em className="text-gold not-italic font-medium">280 tÃ­tulos</em>, situaciones LOMLOE listas e itinerarios por etapa.
            </>
            <${motion.div} ...${fadeUp} transition=${{...ease, delay:1.35}} className="flex flex-wrap items-center justify-center gap-4 mb-16">
              ...
              <a href="recurso.html?timeline=1#sc" className="inline-flex items-center gap-2 text-paper/85 hover:text-paper transition-colors font-mono uppercase tracking-kicker text-[11px] px-3 py-2 group">
                ...
                Ver lÃ­nea del tiempo
              </a>
            </>
            <${motion.div} ...${fadeUp} transition=${{...ease, delay:1.55}} className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
              <${StatCard} icon=${html`<${IconBook} />`}  number="280" suffix="tÃ­tulos" label="CatÃ¡logo curado del fondo Aula de CÃ³mic" />
              <${StatCard} icon=${html`<${IconClock} />`} number="9"   suffix="eras"     label="De Heian (s. XII) a Reiwa contemporÃ¡nea" />
              <${StatCard} icon=${html`<${IconGlobe} />`} number="5"   suffix="niveles"  label="De Infantil a Universidad Â· LOMLOE" />
            </>
          </div>
        </div>
        <${motion.div} ...${fadeUp} transition=${{...ease, delay:1.7}} className="relative z-10 pb-8 px-6 lg:px-12">
          <div className="flex flex-col items-center gap-5 max-w-5xl mx-auto">
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 md:gap-14 text-paper/70 font-heading italic text-xl md:text-2xl tracking-tight">
              <span>Tezuka</span><span>Â·</span><span>Urasawa</span><span>Â·</span><span>Taniguchi</span><span>Â·</span><span>Hokusai</span><span>Â·</span><span>Tatsumi</span>
            </div>
          </div>
        </>
      </section>
  ...
  /* â”€â”€â”€ 4 CAMINOS (PATHS) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  const PATHS = [
    { n:'01', t:'Marco pedagÃ³gico', b:'Por quÃ© el manga funciona en el aula, decÃ¡logo de mediaciÃ³n, anatomÃ­a visual de la pÃ¡gina y protocolo en tres fases.', tags:['DecÃ¡logo','AnatomÃ­a','Protocolo 3 fases','Defender en claustro'], h:'recurso.html#parte-i', icon: html`<${IconBook} size=${24}/>`, featured:false },
    { n:'02', t:'Para primeras etapas', b:'SelecciÃ³n garantÃ­a sin advertencias, criterios para elegir, protocolo de 25 min y errores frecuentes a evitar.', tags:['Infantil','Primaria','6 tÃ­tulos garantÃ­a','Protocolo 25 min'], h:'recurso.html#parte-ii', icon: html`<${IconLayers} size=${24}/>`, featured:true },
    { n:'03', t:'El fondo', b:'280 tÃ­tulos catalogados con criterio docente y enlace OPAC, lÃ­nea del tiempo histÃ³rica de 9 eras y glosario japonÃ©s.', tags:['280 tÃ­tulos','9 eras','OPAC','Glosario'], h:'recurso.html#parte-iii', icon: html`<${IconMap} size=${24}/>`, featured:false },
      ...
      <section id="caminos" className="relative bg-ink2 py-24 md:py-32 px-6 lg:px-12 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="mb-16 max-w-4xl">
            ...
            <${BlurText} text="Por dÃ³nde empezar." italic className="font-heading text-paper text-5xl md:text-7xl leading-[0.95] tracking-[-0.02em] font-semibold mb-6" tag="h2" stagger=${120} />
            <${motion.p} initial=${{ opacity:0, y:10 }} whileInView=${{ opacity:1, y:0 }} viewport=${{ once:true, amount:0.3 }} transition=${{ duration:0.6, delay:0.4 }} className="text-paper/75 text-lg md:text-xl max-w-2xl leading-relaxed">
              El recurso se recorre por la puerta que necesitas. Cuatro entradas distintas segÃºn rol, etapa o momento del curso.
            </>
          </div>
            ...
            ${PATHS.map((p, i) => html`
              ...
              >
                ...
                <div className="flex items-start gap-6">
                  <div className="font-mono text-[10px] uppercase tracking-kicker text-paper/55 pt-2">â€” ${p.n}</div>
  ...
  /* â”€â”€â”€ CAPABILITIES (3 cards) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  const CAPS = [
    { iconKey: 'timeline', t:'LÃ­nea del tiempo', b:'Nueve eras de JapÃ³n desde Heian (s. XII) hasta Reiwa. 57 tÃ­tulos del fondo situados cronolÃ³gicamente con tooltip pedagÃ³gico y enlace al OPAC.', tags:['9 eras','57 tÃ­tulos hitos','Tooltips docentes','LÃ­nea occidental paralela'], cta:'Abrir la lÃ­nea â†’', h:'recurso.html?timeline=1#sc' },
    { iconKey: 'catalog',  t:'CatÃ¡logo curado', b:'280 tÃ­tulos del fondo con descripciÃ³n pedagÃ³gica, badges de uso, nivel y ODS. Filtros cruzados, bÃºsqueda y fichas con sugerencias de aula.', tags:['280 fichas','7 Ã¡reas pedagÃ³gicas','Filtros ODS','BÃºsqueda libre'], cta:'Explorar el catÃ¡logo â†’', h:'recurso.html#catalogo' },
    { iconKey: 'lomloe',   t:'Situaciones LOMLOE', b:'Cinco situaciones de aprendizaje completas (Infantil â†’ Bachillerato) con competencias clave, saberes bÃ¡sicos, secuencia de tareas e instrumentos de evaluaciÃ³n.', tags:['5 niveles','Competencias clave','Saberes bÃ¡sicos','RÃºbrica generada IA'], cta:'Ver situaciones â†’', h:'recurso.html#situaciones' },
  ];
  function capIcon(k) {
      ...
      <section id="fondo" className="relative bg-ink py-24 md:py-32 px-6 lg:px-12 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="mb-16 max-w-3xl">
            <${motion.div} initial=${{ opacity:0, y:10 }} whileInView=${{ opacity:1, y:0 }} viewport=${{ once:true, amount:0.3 }} transition=${{ duration:0.6 }} className="font-mono text-[11px] uppercase tracking-kicker text-gold mb-6">// QuÃ© ofrece el recurso</>
            ...
            <${motion.p} initial=${{ opacity:0, y:10 }} whileInView=${{ opacity:1, y:0 }} viewport=${{ once:true, amount:0.3 }} transition=${{ duration:0.6, delay:0.4 }} className="text-paper/75 text-lg max-w-2xl leading-relaxed">
              No es una pÃ¡gina de consulta puntual: es un instrumento de planificaciÃ³n pedagÃ³gica que crece con el uso.
            </>
          </div>
  ...
  /* â”€â”€â”€ CTA FINAL + footer â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  function CTAFinal() {
    return html`
      <section id="aula" className="relative overflow-hidden">
        <div className="relative min-h-[80vh] flex items-center px-6 lg:px-12 py-32">
          ...
          <div className="relative z-10 max-w-5xl mx-auto w-full text-center">
            ...
            <${motion.p} initial=${{ opacity:0, y:10 }} whileInView=${{ opacity:1, y:0 }} viewport=${{ once:true, amount:0.3 }} transition=${{ duration:0.6, delay:0.5 }} className="text-paper/85 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed mb-12">
              Marco pedagÃ³gico, fondo de 280 tÃ­tulos, situaciones LOMLOE e itinerarios â€” todo en un Ãºnico recurso, abierto y mantenido por la Biblioteca del Campus del Obelisco.
            </>
            <${motion.div} initial=${{ opacity:0, y:10 }} whileInView=${{ opacity:1, y:0 }} viewport=${{ once:true, amount:0.3 }} transition=${{ duration:0.6, delay:0.7 }} className="flex flex-wrap items-center justify-center gap-3">
              ...
              <a href="manual-docente.html" className="inline-flex items-center gap-2 liquid-glass px-5 py-3.5 rounded-full text-paper font-mono uppercase tracking-kicker text-[11px]">âŽ™ Manual docente</a>
        ...
        <div id="equipo" className="relative bg-ink2 px-6 lg:px-12 py-20 border-t border-rule">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
            <div>
              <div className="font-mono text-[10px] uppercase tracking-kicker text-gold mb-4">DirecciÃ³n</div>
              <h3 className="font-heading italic text-paper text-2xl md:text-3xl leading-tight mb-3">Daniel Becerra Romero</h3>
              <p className="text-paper/65 text-sm font-body leading-relaxed">Facultad de Ciencias de la EducaciÃ³n Â· Universidad de Las Palmas de Gran Canaria</p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-paper/85 font-heading italic text-xl md:text-2xl leading-snug">
                ...
                <li>LucÃ­a HernÃ¡ndez Chio</li>
                <li>Daniel HernÃ¡ndez GarcÃ­a</li>
                <li>Zaira RodrÃ­guez Panadero</li>
              </ul>
            </div>
            <div>
              <div className="font-mono text-[10px] uppercase tracking-kicker text-gold mb-4">InstituciÃ³n</div>
              <h3 className="font-heading italic text-paper text-2xl md:text-3xl leading-tight mb-3">Biblioteca Campus del Obelisco</h3>
              <p className="text-paper/65 text-sm font-body leading-relaxed mb-4">Aula de CÃ³mic Â· Facultad de Ciencias de la EducaciÃ³n Â· ULPGC</p>
              <a href="https://educ.ulpgc.es/cultura/aula-de-comic" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 font-mono text-[11px] uppercase tracking-kicker text-gold hover:text-paper transition-colors">
                Aula de CÃ³mic ULPGC <${ArrowUpRight} size=${14} />
              </a>
            </div>
          </div>
          <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-rule flex flex-wrap items-center justify-between gap-4 text-[11px] font-mono uppercase tracking-kicker text-paper/55">
            <span>El manga como recurso didÃ¡ctico Â· v5.9 Â· CC BY-NC 4.0</span>
            <span>5 junio 2026 Â· 280 tÃ­tulos Â· 5 niveles Â· 9 eras</span>
          </div>
        </div>
      </section>
    `;
