...
(function(){
        ...
        <div className="relative z-10 flex-1 flex items-center px-6 lg:px-12 pt-28 pb-12">
          <div className="max-w-5xl mx-auto w-full text-center">
            ...
            <${motion.p} ...${fadeUp} transition=${{...ease, delay:1.15}} className="mx-auto max-w-2xl text-paper/80 text-lg md:text-xl leading-relaxed font-body mb-10">
              Marco pedagógico, catálogo curado de <em className="text-gold not-italic font-medium">281 títulos</em>, situaciones LOMLOE listas e itinerarios por etapa.
            </>
            ...
            <${motion.div} ...${fadeUp} transition=${{...ease, delay:1.55}} className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
              <${StatCard} icon=${html`<${IconBook} />`}  number="281" suffix="títulos" label="Catálogo curado del fondo Aula de Cómic" />
  ...
  const PATHS = [
    ...
    { n:'03', t:'El fondo', b:'281 títulos catalogados con criterio docente y enlace OPAC, línea del tiempo histórica de 9 eras y glosario japonés.', tags:['281 títulos','9 eras','OPAC','Glosario'], h:'recurso.html#parte-iii', icon: html`<${IconMap} size=${24}/>`, featured:false },
  ...
  const CAPS = [
    ...
    { iconKey: 'catalog',  t:'Catálogo curado', b:'281 títulos del fondo con descripción pedagógica, badges de uso, nivel y ODS. Filtros cruzados, búsqueda y fichas con sugerencias de aula.', tags:['281 fichas','7 áreas pedagógicas','Filtros ODS','Búsqueda libre'], cta:'Explorar el catálogo →', h:'recurso.html#catalogo' },
      ...
      <section id="aula" className="relative overflow-hidden">
        <div className="relative min-h-[80vh] flex items-center px-6 lg:px-12 py-32">
          ...
          <div className="relative z-10 max-w-5xl mx-auto w-full text-center">
            ...
            <${motion.p} initial=${{ opacity:0, y:10 }} whileInView=${{ opacity:1, y:0 }} viewport=${{ once:true, amount:0.3 }} transition=${{ duration:0.6, delay:0.5 }} className="text-paper/85 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed mb-12">
              Marco pedagógico, fondo de 281 títulos, situaciones LOMLOE e itinerarios — todo en un único recurso, abierto y mantenido por la Biblioteca del Campus del Obelisco.
            </>
        ...
        <div id="equipo" className="relative bg-ink2 px-6 lg:px-12 py-20 border-t border-rule">
          ...
          <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-rule flex flex-wrap items-center justify-between gap-4 text-[11px] font-mono uppercase tracking-kicker text-paper/55">
            ...
            <span>5 junio 2026 · 281 títulos · 5 niveles · 9 eras</span>
          </div>
        </div>
      </section>
    `;
